                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead >
                            ...
                            <tr>
                                <th colspan="2">
                                    <button type="button" :disabled="btn_search" class="btn btn-sm btn-primary col-xs-12" v-on:click="fetch_expected_delivery()">
            ...
            <div class="panel panel-flat">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(row, i) in list_delivery" :key="i">
                                <td>{{ row.supplier_name }}</td>
                                <td>{{ row.delivery_date | date }}</td>
                            </tr>
                        </tbody>
...
export default {
    ...
    async mounted(){
        getSessionCurrentUrl(this, 'ExpectedDelivery')
        await this.fetch_expected_delivery()
    },
    methods:{
        async fetch_expected_delivery(){
            ...
            try {
                ...
                let result  = await axios.get(apiUrl('purchaser/receive_po/fetch_expected_delivery/'), query)
                let data    = result.data
                this.list_delivery = data.list_delivery
            } catch (error) {
