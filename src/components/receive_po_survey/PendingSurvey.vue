        ...
        <div class="content-wrapper col-sm-12" >
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <p class="panel-title">PENDING PRICE SURVEY</p>
...
export default {
    ...
    methods: {
        async fetch_pending_po() {
            ...
            try {
                let result  = await axios.get(apiUrl('purchaser/receive_po_survey/fetch_pending_survey'),tokenApi)
        ...
        async view_po(po_no){
            this.$router.push({ name: 'ReceivePoSurvey', query: { po_no } })
        },
