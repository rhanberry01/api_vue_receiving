        ...
        <div class="content-wrapper col-sm-12" >
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <p>
                         <a style="border-radius:0px;">&nbsp;&nbsp;<i class="icon icon-undo"></i><router-link to="/receive/transfer-community-palengke/receive"> CLICK ME TO BACK</router-link> </a>
                    </p>
...
export default {
    ...
    async mounted(){
      ...
      getSessionCurrentUrl(this, 'TransferCommunityPalengkeReceiveReceive')
    },
    methods:{
        async openscan(){
        ...
        async fetch_barcode() {
            ...
            try {
                ...
                await axios.post(apiUrl('purchaser/receive_po/transfer-community-palengke/receive/fetch_barcode'), data, tokenApi())
                await this.fetch_temporary_items(this.p_transfer_no)
            } catch (error) {
        ...
        async fetch_temporary_items(transfer_id) {
            try {
                ...
                let result = await axios.get(apiUrl('purchaser/receive_po/transfer-community-palengke/receive/fetch_temporary_items'), query)
        ...
        async delete_items(temp_receiving_id, id) {
            try {
                ...
                if(confirm) {
                    ...
                    await axios.post(apiUrl('purchaser/receive_po/transfer-community-palengke/receive/delete_items'), data, tokenApi())
                    await this.fetch_temporary_items(this.p_transfer_no)
        ...
        async fetch_receive_transfer_details(){
           this.loading_receive_details = true //activate loading
            try {
                ...
                let result  = await axios.get(apiUrl('purchaser/receive_po/transfer-community-palengke/receive/fetch_receive_transfer_details'), query)
                let data    = result.data
        ...
        async post_receiving() {
            try {
                ...
                await axios.post(apiUrl('purchaser/receive_po/transfer-community-palengke/receive/post_receiving'), formData, tokenApi())
                this.$session.flash.set('p_message', 'OK')
                this.$router.push({ name: 'TransferCommunityPalengkeReceiveReceive' })
                await this.refresh()
