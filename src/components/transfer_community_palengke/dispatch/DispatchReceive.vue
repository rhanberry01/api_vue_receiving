        ...
        <div class="content-wrapper col-sm-12" >
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <p>
                         <a style="border-radius:0px;">&nbsp;&nbsp;<i class="icon icon-undo"></i><router-link to="/receive/transfer-community-palengke/dispatch"> CLICK ME TO BACK</router-link> </a>
                    </p>
    ...
    methods:{
        ...
        async fetch_barcode() {
            ...
            try {
                ...
                // console.log()
                await axios.post(apiUrl('purchaser/receive_po/transfer-community-palengke/dispatch/fetch_barcode'), data, tokenApi())
                await this.fetch_temporary_items(this.p_transfer_no)
            } catch (error) {
        ...
        async fetch_temporary_items(transfer_id) {
            try {
                ...
                let result = await axios.get(apiUrl('purchaser/receive_po/transfer-community-palengke/dispatch/fetch_temporary_items'), query)
        ...
        async delete_items(temp_receiving_id, id) {
            try {
                ...
                if(confirm) {
                    ...
                    let result = await axios.post(apiUrl('purchaser/receive_po/transfer-community-palengke/dispatch/delete_items'), data, tokenApi())
                    let res   = result.data
        ...
        async fetch_dispatch_transfer_details(){
           this.loading_dispatch_details = true //activate loading
            try {
                ...
                let result  = await axios.get(apiUrl('purchaser/receive_po/transfer-community-palengke/dispatch/fetch_dispatch_transfer_details'), query)
                let data    = result.data
        ...
        async post_receiving() {
            ...
            try {
                ...
                await axios.post(apiUrl('purchaser/receive_po/transfer-community-palengke/dispatch/post_receiving'), data, tokenApi())
                this.$session.flash.set('p_message', 'OK')
                this.$router.push({ name: 'TransferCommunityPalengkeDispatch' })
                await this.refresh()
